...
func init() {
	...
	gOpts.keys["cc"] = &callExpr{"copy", nil, 1}
	...
	gOpts.keys[`cr`] = &callExpr{"rename", nil, 1}
	...
	gOpts.cmdkeys["<a-left>"] = &callExpr{"cmd-home", nil, 1}
	gOpts.cmdkeys["<end>"] = &callExpr{"cmd-end", nil, 1}
	gOpts.cmdkeys["<a-right>"] = &callExpr{"cmd-end", nil, 1}
	gOpts.cmdkeys["<c-u>"] = &callExpr{"cmd-delete-home", nil, 1}
	gOpts.cmdkeys["<c-k>"] = &callExpr{"cmd-delete-end", nil, 1}
	gOpts.cmdkeys["<c-backspace2>"] = &callExpr{"cmd-delete-unix-word", nil, 1}
	...
	gOpts.cmdkeys["<c-right>"] = &callExpr{"cmd-word", nil, 1}
	gOpts.cmdkeys["<c-left>"] = &callExpr{"cmd-word-back", nil, 1}
